# react-clicker-heroes
 a memory game utilizing React.  The application's UI is broken into components, with a focus on management of the component state, which responds to user events.
